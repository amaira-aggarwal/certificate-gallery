...
(function (root, factory) {
  ...
  Lightbox.prototype.updateDetails = function () {
    ...
    if (
      ...
      $description
        .text(this.album[this.currentImageIndex].description)
        .fadeIn("fast");
    } else {
